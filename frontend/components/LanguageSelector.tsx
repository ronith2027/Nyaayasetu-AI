        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            <div className="max-w-md w-full p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl transform transition-all">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">{t('chooseLanguage')}</h1>
                    <p className="text-gray-500 dark:text-gray-400">{t('chooseLanguageSubtitle')}</p>
                </div>
