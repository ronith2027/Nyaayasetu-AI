    ...
    return (
        <div className="scheme-container">
            <div className="scheme-header">
                <h2 className="scheme-title">{t('checkEligibility')}</h2>
                <p className="scheme-subtitle">{t('fillDetailsSchemes')}</p>
            </div>

            <div className="scheme-form-card">
                <div className="scheme-grid">
                    <div className="scheme-input-group">
                        <label className="scheme-label">{t('age')}</label>
                        <input
                            type="number"
                    ...
                    <div className="scheme-input-group">
                        <label className="scheme-label">{t('category')}</label>
                        <select
                    ...
                    <div className="scheme-input-group">
                        <label className="scheme-label">{t('annualIncome')}</label>
                        <input
                            type="number"
                            className="scheme-input"
                    ...
                    <div className="scheme-input-group" style={{ gridColumn: '1 / -1' }}>
                        <label className="scheme-label">{t('occupation')}</label>
                        <input
                            type="text"
                            className="scheme-input"
                ...
                <div className="scheme-submit-container">
                    ...
                    >
                        {loading ? <Loader /> : t('discoverSchemes')}
                    </button>
                </div>
            </div>
        </div>
